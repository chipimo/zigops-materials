...
import { Tabs, TabsHeader, Tab, Typography, Button, Tooltip } from "@zigops-material/react";

export default function Header() {
  const [version, setVersion] = useState("npm i @zigops-material/react");
  ...
  return (
    <div className="h-screen min-h-screen bg-[url('/img/bg-header.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-between">
            <div className="mt-48 w-full px-4 md:w-8/12 lg:mt-4 lg:w-5/12">
                ...
                <Tabs value="react" className="mb-6">
                  ...
                  >
                    <Tab
                      ...
                      onClick={() => setVersion("npm i @zigops-material/react")}
                    >
              ...
              <Typography variant="h1" className="mb-2 font-black tracking-normal text-[#1A237E]">
                ZigOps Material
              </Typography>
              <Typography className="mb-6 text-lg font-light text-[#1A237E] lg:pr-12">
                ZigOps Material is an easy to use components library for Tailwind CSS and Material
                Design.
              </Typography>
