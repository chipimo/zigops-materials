    ...
    <section className="py-12">
      <div className="flex flex-wrap items-center">
        <div className="relative w-full px-4 md:w-5/12">
          <Typography variant="h2" className="mb-2 font-black tracking-normal text-[#1A237E]">
            Realistic <br />
            <Typography
              as="span"
              variant="h2"
          ...
          <Typography className="mb-5 text-lg text-[#1A237E]/60 md:pr-10">
            Create a cohesive and modern-looking design. They will help your elements to pop-up.
          </Typography>
        </div>
        <div className="relative w-full px-4 pt-10 md:w-6/12 md:pt-0">
          ...
          />
          <img
            className="absolute -bottom-16 w-full md:-right-5 md:bottom-auto md:top-24 lg:-right-40 lg:top-10"
            src="/img/blue.png"
            alt="tailwind_blob_blue"
          />
          <img
            className="absolute right-0 top-36 z-30 w-1/2 rounded-lg shadow-2xl shadow-blue-gray-500/20 md:top-12 lg:-right-24"
            src="/img/shadows.png"
