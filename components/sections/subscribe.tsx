...
import { Typography, Button, Input } from "packages/zigops-material-react/src";
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center p-5 md:p-10">
        ...
        <div className="w-full px-4 lg:w-6/12">
          <form
            action="https://zigops-material.us1.list-manage.com/subscribe/post?u=e97df4875fc1b2fb28f609b88&amp;id=628d9b1722"
            method="post"
