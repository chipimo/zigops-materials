...
import { Typography, Button } from "packages/zigops-material-react/src";
      ...
      <div className="flex flex-wrap items-center">
        <div className="w-full px-4 lg:w-5/12">
          ...
          <Typography className="mb-5 text-lg text-[#1A237E]/60 md:pr-10">
            ZigOps Material provides a simple way to customize your button;
        ...
        <div className="relative mt-10 w-full px-4 md:w-8/12 lg:mt-0 lg:w-6/12">
          <CodePreview
            code={`import { Button } from "@zigops-material/react";
