---
title: Tailwind CSS Progress Bar for React - ZigOps Material
...
```jsx
import { Progress } from "@zigops-material/react";
...
```jsx
import { Progress, Typography } from "@zigops-material/react";
