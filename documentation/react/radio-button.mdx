---
title: Tailwind CSS Radio for React - ZigOps Material
...
```jsx
import { Radio } from "@zigops-material/react";
      ...
      label={
        <div>
          ...
          <Typography variant="small" color="gray" className="font-normal">
            @zigops-material/html, packed with rich components and widgets.
          </Typography>
        </div>
      }
      containerProps={{
    ...
    <Radio 
      ...
      label={
        <div>
          ...
          <Typography variant="small" color="gray" className="font-normal">
            @zigops-material/react, packed with rich components and widgets.
          </Typography>
        </div>
      }
      containerProps={{
