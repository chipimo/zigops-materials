---
title: Tailwind CSS Breadcrumbs for React - ZigOps Material
...
Use our Tailwind CSS <Code>Breadcrumbs</Code> component to simply create beautiful <Code>Breadcrumbs</Code> for your pages with ZigOps Material.
...
```jsx
import { Breadcrumbs } from "@zigops-material/react";
