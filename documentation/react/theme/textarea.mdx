---
title: Tailwind CSS Textarea Theme - ZigOps Material
...
```tsx
import type { TextareaStylesType } from "@zigops-material/react";
```
...
```tsx
import type { TextareaVariantStylesType } from "@zigops-material/react";
```
...
```tsx
import type { TextareaSizeStylesType } from "@zigops-material/react";
```
...
```tsx
import type { TextareaStateStylesType } from "@zigops-material/react";
```
