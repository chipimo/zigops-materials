---
title: ZigOps Material Migration Guide - React & Tailwind CSS Components Library
description: Learn how to migrate to @zigops-material/react@2.0.0.
...
ZigOps Material React 2.0 introduces a number of breaking changes, We tried keeping the amount of breaking changes to a minimum.
