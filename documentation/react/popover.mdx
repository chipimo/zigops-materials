---
title: Tailwind CSS Popover for React - ZigOps Material
...
<CodePreview id="popover-with-image" component={
  <Popover>
    ...
    <PopoverContent className="w-[28rem] p-0 overflow-hidden flex z-[999]">
      <div className="p-4">
        <Typography color="blue-gray" className="font-medium mb-2">ZigOps Material</Typography>
        <Typography variant="small" color="gray" className="font-normal mb-4">
          ZigOps Material is an easy to use components library for Tailwind CSS and Material Design. It features multiple React and HTML components, all written with Tailwind CSS classes and Material Design guidelines.
        </Typography>
      ...
      {({ setState, open }) => (
        <Popover open={open} handler={setState}>
          ...
          >
            ...
            <Typography variant="small" color="gray" className="font-normal">
              @zigops-material is an easy-to-use components library for Tailwind
