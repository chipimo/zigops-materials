---
title: Tailwind CSS Tabs Props - ZigOps Material
...
```tsx
import type { TabsProps } from "@zigops-material/react";
```
...
```tsx
import type { TabsHeaderProps } from "@zigops-material/react";
```
...
```tsx
import type { TabsBodyProps } from "@zigops-material/react";
```
...
```tsx
import type { TabProps } from "@zigops-material/react";
```
...
```tsx
import type { TabPanelProps } from "@zigops-material/react";
```
