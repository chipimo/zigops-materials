---
title: Tailwind CSS Accordion Props - ZigOps Material
...
```tsx
import type { AccordionProps } from "@zigops-material/react";
```
...
```tsx
import type { AccordionHeaderProps } from "@zigops-material/react";
```
...
```tsx
import type { AccordionBodyProps } from "@zigops-material/react";
```
