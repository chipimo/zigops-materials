---
title: Tailwind CSS Select Props - ZigOps Material
...
```tsx
import type { SelectProps } from "@zigops-material/react";
```
...
```tsx
import type { SelectOptionProps } from "@zigops-material/react";
```
