---
title: Tailwind CSS Badge for React - ZigOps Material
...
```jsx
import { Badge, Button } from "@zigops-material/react";
...
```jsx
import { Badge, IconButton, Avatar } from "@zigops-material/react";
