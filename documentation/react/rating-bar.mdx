---
title: Tailwind CSS Rating Bar for React - ZigOps Material
...
```jsx
import { Rating } from "@zigops-material/react";
...
import { Rating, Typography } from "@zigops-material/react";
...
```jsx
import { Typography, Avatar, Rating } from "@zigops-material/react";
