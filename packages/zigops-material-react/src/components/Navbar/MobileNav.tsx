...
export const MobileNav = React.forwardRef<HTMLDivElement, MobileNavProps>(
  ({ open, animate, className, children, ...rest }, ref) => {
    console.error(
      `<MobileNav /> will be deprecated in the future versions of @zigops-material/react use <Collapse /> instead.
      
More details: https://www.zigops-material.com/docs/react/collapse
      `,
    );
...
MobileNav.displayName = "ZigOpsMaterial.MobileNav";
